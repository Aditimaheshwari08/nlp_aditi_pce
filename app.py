...
html_temp = """
   ...
   <div class="clearfix">           
   <div class="col-md-12">
   <center><p style="font-size:40px;color:black;margin-top:10px;">Poornima college of Engg</p></center> 
   <center><p style="font-size:30px;color:black;margin-top:10px;">Department of Information Techonology</p></center> 
   <center><p style="font-size:25px;color:black;margin-top:10px;"Summer Internship 2022</p></center> 
   </div>
   </div>
   </div>
   """
...
if st.button("About"):
  st.subheader("Developed by Aditi Maheshwari")
  st.subheader("PCE19IT001")
html_temp = """
